        ...
        <div className="content-container">
          <div className="privacy-policy-content">
            <div className="privacy-header">
              ...
              <p className="privacy-last-updated">Last updated: June 18, 2024</p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <div className="privacy-definitions">
                ...
                <p>
                  ...
                  in this Agreement) refers to Precision Motorsports LLC, 38410 Grand River Ave
                  Suite G, Farmington, MI 48335.
                </p>
                ...
                <p>
                  <strong>Website</strong> refers to Precision Motorsports LLC, accessible from
            ...
            <div className="privacy-section">
              ...
              <h4 className="privacy-subsection-subtitle">Personal Data</h4>
              <p>
              ...
              <h4 className="privacy-subsection-subtitle">Usage Data</h4>
              ...
              <h4 className="privacy-subsection-subtitle">
            ...
            <div className="privacy-section">
              ...
              <div className="privacy-cookies">
                <h4 className="privacy-subsection-subtitle">Necessary / Essential Cookies</h4>
                <p>
                ...
                <p>
                  ...
                  available through the Website and to enable You to use some of its features. They
                  help to authenticate users and prevent fraudulent use of user accounts. Without
                ...
                <h4 className="privacy-subsection-subtitle">Functionality Cookies</h4>
                <p>
                  <strong>Type:</strong> Persistent Cookies
                </p>
                <p>
                ...
                <p>
                  ...
                  experience and to avoid You having to re-enter your preferences every time You use
                  the Website.
                </p>
              </div>
            ...
            <div className="privacy-section">
              ...
              <h3 className="privacy-subsection-title">Business Transactions</h3>
              <p>
              ...
              <h3 className="privacy-subsection-title">Law enforcement</h3>
              <p>
              ...
              <h3 className="privacy-subsection-title">Other legal requirements</h3>
              <p>
