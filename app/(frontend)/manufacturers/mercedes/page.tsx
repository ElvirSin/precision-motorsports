...
export default function MercedesPage() {
  ...
  const carImage = '/manufacturers/car-images/mercedes.webp'
  const carAlt = 'Mercedes-Benz'
      ...
      <section className="manufacturer-hero">
        <div className="manufacturer-hero-container">
          <div className="hero-content">
            <h1 className="hero-title">MERCEDES-BENZ SERVICE BY INDEPENDENT EXOTIC CAR EXPERTS</h1>
            <p className="hero-tagline">Proprietary diagnostics. Quiet luxury. Reliable care.</p>
            <p className="hero-description">
              Your Mercedes-Benz deserves more than a generic repair shop. We're one of the few
              independents equipped with proprietary Mercedes-Benz diagnostic tools, giving us
              ...
              discretion. From C-Class to AMG GT, we offer everything from preventative maintenance
              to tasteful cosmetic upgrades and restorations, all delivered with craftsmanship that
          ...
          <div className="hero-image">
            <Image
              src="/manufacturers/car-images/mercedes.webp"
              alt="Mercedes-Benz"
              width={600}
              height={400}
