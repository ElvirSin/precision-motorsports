      ...
      <section className="manufacturer-hero">
        <div className="manufacturer-hero-container">
          <div className="hero-content">
            <h1 className="hero-title">ASTON MARTIN SERVICE BY INDEPENDENT EXOTIC CAR EXPERTS</h1>
            <p className="hero-tagline">Proprietary diagnostics. Quiet luxury. Reliable care.</p>
            <p className="hero-description">
              Your Aston Martin deserves more than a generic repair shop. We're one of the few
              independents equipped with proprietary Aston Martin diagnostic tools, giving us
              ...
              discretion. From DBII to Vantage, we offer everything from preventative maintenance to
