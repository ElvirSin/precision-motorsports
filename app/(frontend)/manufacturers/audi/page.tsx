      ...
      <section className="manufacturer-hero">
        <div className="manufacturer-hero-container">
          <div className="hero-content">
            <h1 className="hero-title">AUDI SERVICE BY INDEPENDENT EXOTIC CAR EXPERTS</h1>
            <p className="hero-tagline">Proprietary diagnostics. Quiet luxury. Reliable care.</p>
            <p className="hero-description">
              Your Audi deserves more than a generic repair shop. We're one of the few independents
              equipped with proprietary Audi diagnostic tools, giving us dealer-level insight
              without dealer-level prices. We address known issues like cooling system failures,
              suspension wear, and electrical glitches with expertise and discretion. From A3 to R8,
              we offer everything from preventative maintenance to tasteful cosmetic upgrades and
