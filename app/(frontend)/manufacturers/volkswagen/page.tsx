...
export default function VolkswagenPage() {
  ...
  const carImage = '/manufacturers/car-images/vw.webp'
  const carAlt = 'Volkswagen'
      ...
      <section className="manufacturer-hero">
        <div className="manufacturer-hero-container">
          <div className="hero-content">
            <h1 className="hero-title">VOLKSWAGEN SERVICE BY INDEPENDENT EXOTIC CAR EXPERTS</h1>
            <p className="hero-tagline">Proprietary diagnostics. Quiet luxury. Reliable care.</p>
            <p className="hero-description">
              Your Volkswagen deserves more than a generic repair shop. We're one of the few
              independents equipped with proprietary Volkswagen diagnostic tools, giving us
              ...
              discretion. From Golf to Touareg, we offer everything from preventative maintenance to
          ...
          <div className="hero-image">
            <Image
              src="/manufacturers/car-images/vw.webp"
              alt="Volkswagen"
              width={600}
              height={400}
