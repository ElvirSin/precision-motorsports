      ...
      <section className="manufacturer-hero">
        <div className="manufacturer-hero-container">
          <div className="hero-content">
            <h1 className="hero-title">LAMBORGHINI SERVICE BY INDEPENDENT EXOTIC CAR EXPERTS</h1>
            <p className="hero-tagline">Proprietary diagnostics. Quiet luxury. Reliable care.</p>
            <p className="hero-description">
              Your Lamborghini deserves more than a generic repair shop. We're one of the few
              independents equipped with proprietary Lamborghini diagnostic tools, giving us
              ...
              discretion. From Huracán to Aventador, we offer everything from preventative
