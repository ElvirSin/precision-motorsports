        ...
        <div className="content-container">
          <div className="privacy-policy-content">
            <div className="privacy-header">
              ...
              <p className="privacy-last-updated">Last updated: January 17, 2025</p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <div className="privacy-definitions">
                ...
                <p>
                  ...
                  in this Agreement) refers to Precision Motorsports, 38410 Grand River Ave Suite G,
                  Farmington, MI 48335.
                </p>
                ...
                <p>
                  <strong>Website</strong> refers to Precision Motorsports, accessible from
                  precision-motorsports.com
                </p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Acknowledgment</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Termination</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Limitation of Liability</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Governing Law</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Disputes Resolution</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">For European Union (EU) Users</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">United States Legal Compliance</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Severability and Waiver</h2>

              <h3 className="privacy-subsection-title">Severability</h3>
              <p>
              ...
              <h3 className="privacy-subsection-title">Waiver</h3>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Translation Interpretation</h2>
              <p>
            ...
            <div className="privacy-section">
              <h2 className="privacy-section-title">Changes to These Terms and Conditions</h2>
              <p>
            ...
            <div className="privacy-section">
              ...
              <p>By email: support@precision-motorsports.com</p>
            </div>
          </div>
        </div>
      </section>
