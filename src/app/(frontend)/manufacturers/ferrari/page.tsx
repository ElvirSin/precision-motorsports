      ...
      <section className="manufacturer-hero">
        <div className="manufacturer-hero-container">
          <div className="hero-content">
            <h1 className="hero-title">FERRARI SERVICE BY INDEPENDENT EXOTIC CAR EXPERTS</h1>
            <p className="hero-tagline">Proprietary diagnostics. Quiet luxury. Reliable care.</p>
            <p className="hero-description">
              Your Ferrari deserves more than a generic repair shop. We're one of the few
              independents equipped with proprietary Ferrari diagnostic tools, giving us
              ...
              discretion. From 308 to SF90, we offer everything from preventative maintenance to
